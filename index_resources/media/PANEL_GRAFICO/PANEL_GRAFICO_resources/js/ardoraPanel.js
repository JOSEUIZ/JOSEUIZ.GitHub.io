...
function isCorrect(cell) {score=0;successes=0;var correct=false;for (i=0;i<answers.length;i++) {var isDone=false;if ($("#txt"+String(i+1)).hasClass("txtCellOk")){isDone=true;}
